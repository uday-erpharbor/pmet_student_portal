...
export class CategoryProductField extends Many2OneField {
    static props = {
        ...Many2OneField.props,
    ...
    setup() {
        ...
        useEffect(value => {
            if (!isMounted) {
                ...
                if (this.relation === "thinkplc.assets") {
...
// Customization start
    get hasConfigurationButton() {
        return this.isConfigurableCategory;
    }
...
// Customization End
    ...
    onEditConfiguration() {
        this._editCategoryConfiguration();
    }
    _editCategoryConfiguration() {} // product_category_configurator, sale_product_matrix
}

CategoryProductField.template = "generator.CategoryProductField";

export const ProductCategoryField = {
    ...many2OneField,
    component: CategoryProductField,
...
registry.category("fields").add("category_product_many2one", ProductCategoryField);
