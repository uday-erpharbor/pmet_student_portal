...
class Account(models.Model):
    ...
    def _search(self, domain, offset=0, limit=None, order=None):
        ...
        if global_search:
            ...
            global_inv_field_ids = self.env.company and self.env.company.sudo().global_inv_field_ids

            global_args = []
            for field in global_inv_field_ids:
        ...
        return super(Account, self)._search(domain, offset=offset, limit=limit, order=order)
